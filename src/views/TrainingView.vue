        ...
        <!--    <button type="submit" class="btn btn-primary w-100">신청</button>-->
            ...
            <div style="background:#f6faff; border:1px solid #eee; border-radius: 2px; padding:10px; margin: 30px 0">
                ...
                <div class="refund-policy">
                    <p>※ 환불규정</p>
                    <ul>
                        <li>장보기 전까지 대회 불참이면 100쁘로 환불!</li>
                        <li>장보기 후에는 장을 봤는데 우야노.. 대회 불참은 기부하는걸로 하입시다.</li>
                    </ul>
                </div>
...
export default {
    data(){
        return {
            apiUrl : "https://bonobono-e6ed4-default-rtdb.asia-southeast1.firebasedatabase.app/training.json",
            formData  :{
                checked      :'',
                name      :'',
                affiliation     :'',
    ...
    mounted(){
        ...
        const dataRef = ref(this.db, 'training'); // cheering 경로에 대한 참조
