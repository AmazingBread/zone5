<template>
    <div>
        <img src="@/assets/image/대구장거리.jpg" class="img-fluid" alt="cheering" />
...
export default {
    data(){
        return {
            apiUrl : "https://bonobono-e6ed4-default-rtdb.asia-southeast1.firebasedatabase.app/cheering_deagujang.json",
            formData  :{
                name      :'',
                message     :'',
                date :'',
    ...
    mounted(){
        ...
        const dataRef = ref(this.db, 'cheering_deagujang'); // cheering 경로에 대한 참조
