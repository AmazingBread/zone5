...
export default {
    data(){
        return {
            ...
            firstComeLimit: 50,
            deadline: new Date('2026-03-13T15:59:59'),
    ...
    methods:{
        ...
        downloadExcel() {
            ...
            XLSX.utils.book_append_sheet(workbook, worksheet, "zone4 신청자명단");

            // 파일 다운로드
            XLSX.writeFile(workbook, "zone4 신청자명단.xlsx");
        }
    }
};
</script>
