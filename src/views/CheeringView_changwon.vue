<template>
    <div>
        <img src="@/assets/image/cheering_changwon_s.jpg" class="img-fluid" alt="cheering" />
...
export default {
    data(){
        return {
            apiUrl : "https://bonobono-e6ed4-default-rtdb.asia-southeast1.firebasedatabase.app/cheering_changwon.json",
            formData  :{
                name      :'',
                message     :'',
                date :'',
    ...
    mounted(){
        ...
        const dataRef = ref(this.db, 'cheering_changwon'); // cheering 경로에 대한 참조
