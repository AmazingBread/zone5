<template>
    <div>
        ...
        <table class="fit-table">
            ...
            <tr>
                <th>
                    <input type="number" v-model="goals.swim" placeholder="100" style="width:100px"/> k
            ...
            <tbody>
            <tr v-for="(day, index) in daysInMonth" :key="index" :class="{ 'today-row': isToday(day) }">
                <td style="width:80px;">{{ day }}일</td>
                <td><input type="number" v-model="records[day].swim" style="width:100px"/> k</td>
...
export default {
    ...
    methods:{
        ...
        saveUserData() {
            ...
            .then(() => {
                alert("저장 완료됐습니다 행님!");
                this.$router.push('/fit_diary_zone_five');
            })
             .catch((error) => {
