<template>
    <div>
        <h2 class="page_title mb-4">팀물보노 대구 대회 6월 21-22일</h2>
        <img src="@/assets/image/daegu.jpg" class="img-fluid" alt="진주" style="width: 100%" />

        <p class="text-center text-bg-info p-2">📢📢📢  팀물보노 신청서 🏅🏅🏅🏅</p>
        <h2 class="page_title mb-4 text-bg-warning p-2">신청마감 5월 18일 일요일 까지</h2>
        <form @submit.prevent="submitForm">
            ...
            <div class="mb-3">
                ...
                <div>
                    ...
                    <div class="form-check d-inline-block me-3"> <!-- d-inline-block을 사용하여 인라인 블록으로 설정 -->
                        <input class="form-check-input" type="radio" name="events1" id="bk100_1" value="배영100" v-model="formData.events1" ref="events1">
                        <label class="form-check-label" for="bk100_1">배영100</label>
                    </div>
                    <div class="form-check d-inline-block me-3"> <!-- d-inline-block을 사용하여 인라인 블록으로 설정 -->
                    ...
                    <div class="form-check d-inline-block me-3"> <!-- d-inline-block을 사용하여 인라인 블록으로 설정 -->
                        <input class="form-check-input" type="radio" name="events1" id="br100_1" value="평영100" v-model="formData.events1" ref="events1">
                        <label class="form-check-label" for="br100_1">평영100</label>
                    </div>
                    <div class="form-check d-inline-block me-3"> <!-- d-inline-block을 사용하여 인라인 블록으로 설정 -->
                    ...
                    <div class="form-check d-inline-block me-3"> <!-- d-inline-block을 사용하여 인라인 블록으로 설정 -->
                        <input class="form-check-input" type="radio" name="events1" id="fl100_1" value="접영100" v-model="formData.events1" ref="events1">
                        <label class="form-check-label" for="fl100_1">접영100</label>
                    </div>
                    <div class="form-check d-inline-block me-3"> <!-- d-inline-block을 사용하여 인라인 블록으로 설정 -->
            ...
            <div class="mb-3">
                ...
                <div>
                    ...
                    <div class="form-check d-inline-block me-3"> <!-- d-inline-block을 사용하여 인라인 블록으로 설정 -->
                        <input class="form-check-input" type="radio" name="events2" id="bk100_2" value="배영100" v-model="formData.events2" ref="events2">
                        <label class="form-check-label" for="bk100_2">배영100</label>
                    </div>
                    <div class="form-check d-inline-block me-3"> <!-- d-inline-block을 사용하여 인라인 블록으로 설정 -->
                    ...
                    <div class="form-check d-inline-block me-3"> <!-- d-inline-block을 사용하여 인라인 블록으로 설정 -->
                        <input class="form-check-input" type="radio" name="events2" id="br100_2" value="평영100" v-model="formData.events2" ref="events2">
                        <label class="form-check-label" for="br100_2">평영100</label>
                    </div>
                    <div class="form-check d-inline-block me-3"> <!-- d-inline-block을 사용하여 인라인 블록으로 설정 -->
                    ...
                    <div class="form-check d-inline-block me-3"> <!-- d-inline-block을 사용하여 인라인 블록으로 설정 -->
                        <input class="form-check-input" type="radio" name="events2" id="fl100_2" value="접영100" v-model="formData.events2" ref="events2">
                        <label class="form-check-label" for="fl100_2">접영100</label>
                    </div>
                    <div class="form-check d-inline-block me-3"> <!-- d-inline-block을 사용하여 인라인 블록으로 설정 -->
                        <input class="form-check-input" type="radio" name="events2" id="im200_2" value="개인혼영200" v-model="formData.events2" ref="events2">
                        <label class="form-check-label" for="im200_2">개인혼영200</label>
                    </div>
                    <div class="form-check d-inline-block me-3"> <!-- d-inline-block을 사용하여 인라인 블록으로 설정 -->
                        <input class="form-check-input" type="radio" name="events2" id="pinFr50_2" value="오리발 자유형 50" v-model="formData.events2" ref="events2">
                        <label class="form-check-label" for="pinFr50_2">오리발 자유형 50</label>
                    </div>
                    <div class="form-check d-inline-block me-3"> <!-- d-inline-block을 사용하여 인라인 블록으로 설정 -->
                        <input class="form-check-input" type="radio" name="events2" id="pinFl50_2" value="오리발 접영 50" v-model="formData.events2" ref="events2">
                        <label class="form-check-label" for="pinFl50_2">오리발 접영 50</label>
                    </div>
                </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="size" v-model="formData.ok" ref="sizeSelect">
                    ...
                    <option value="장소, 시간 확인함">대회비 3만 (먹는것 현장에서 각출)</option>
                </select>
            ...
            <div style="background:#f6faff; border:1px solid #eee; border-radius: 2px; padding:10px; margin: 30px 0">
                ...
                <p style="font-size:12px;">
                    ...
                    3. 수경수모 혹시모른다 2개씩 챙기소<br>
                    4. 수정은 안되니 다시 작성하세요. 뒤에껀 내가 지우께요<br><br>
...
export default {
    data(){
        return {
            apiUrl : "https://bonobono-e6ed4-default-rtdb.asia-southeast1.firebasedatabase.app/swimming_competition3.json",
            formData  :{
                checked      :'',
                name      :'',
                age      :'',
            ...
            accountText: '79420390777 카카오뱅크 30,000원'
        };
    },
    mounted(){
        ...
        const dataRef = ref(this.db, 'swimming_competition3'); // cheering 경로에 대한 참조
        onValue(dataRef, (snapshot) => {
            const getData = snapshot.val() || {};
            this.apiData = Object.keys(getData)
                .filter(key => key !== 'swimming_competition3_exemptCount') // exemptCount를 제외
                .map(key => ({
