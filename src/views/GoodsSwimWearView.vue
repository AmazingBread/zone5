<template>
    <div>
        ...
        <h2 class="page_title">보노보노 한정판 리미티드 수영복 신청</h2>
        <br><br><br>
        <br><br><br>
        <img src="@/assets/image/swimwear_pattern.jpg" class="img-fluid" alt="썸네일" />
        <h2 class="page_title highlighted-text mb-4">(11월 14일 오후7시 신청마감)</h2>
        <br><br><br>
        ...
        <br><br><br>
        <img src="@/assets/image/onedan.jpg" class="img-fluid" alt="썸네일" />
        <br><br><br>
        <br><br><br>
        ...
        <form @submit.prevent="submitForm">
            ...
            <div class="mb-3">
                <label for="order" class="form-label fw-bold">수영복 사이즈 주문</label>
                <select class="form-select" id="openClass" v-model="formData.order" ref="openClassSelect">
                    <option value="" disabled>수영복 사이즈 선택</option>
                    <option value="여성 kids">여성 kids</option>
                    <option value="여성 SS">여성 SS</option>
                    <option value="여성 S">여성 S</option>
                    <option value="여성 M">여성 M</option>
                    <option value="여성 L">여성 L</option>
                    <option value="여성 XL">여성 XL</option>
                    <option value="남성 kids">남성 kids</option>
                    <option value="남성 B8">남성 B8</option>
                    <option value="남성 B10">남성 B10</option>
                    <option value="남성 B12">남성 B12</option>
                    <option value="남성 B14">남성 B14</option>
                    <option value="남성 Mxs">남성 Mxs</option>
                </select>
            ...
            <div style="background:#f6faff; border:1px solid #eee; border-radius: 2px; padding:10px; margin: 30px 0">
                ...
                <p style="font-size:12px;">
                    1. 여성 수영복은 59,000원 입니다<br>
                    2. 남성 수영복은 49,000원 입니다<br>
                    3. 제품수령은 오프라인 모임으로 수령가능 (택배x)<br>
...
export default {
    ...
    methods:{
        ...
        validateForm() {
            ...
            if (!order) {
                this.showMessage("수영복 사이즈 작성하이소", 3);
