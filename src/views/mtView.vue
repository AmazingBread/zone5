<template>
    <div>
        <img src="@/assets/image/엠티메인.jpg" class="img-fluid" alt="썸네일">
        <h2 class="page_title mb-4">📣📣9월 13-14 ZOO,어깨탈골,보노보노 연합MT📣📣</h2>
        <div class="alert alert-danger font-weight-bold text-center mt-4" role="alert" style="font-size: 1.2rem; border: 3px solid #dc3545;">
            ❗ <strong>주의!</strong> ZOO, 어깨탈골, 보노보노 동호회 이외의 사람은 <u>신청할 수 없습니다</u> ❗
        </div>
        ...
        <form @submit.prevent="submitForm">
            ...
            <div class="mb-3">
                ...
                <div>
                    ...
                    <!--    <input class="form-check-input" type="radio" name="affiliation" id="daun" value="팀김다은" v-model="formData.affiliation">-->
                    <!--    <label class="form-check-label" for="daun">팀김다은</label>-->
                    <!--</div>-->
                    <!--<div class="form-check d-inline-block me-3 mt-3"> &lt;!&ndash; d-inline-block을 사용하여 인라인 블록으로 설정 &ndash;&gt;-->
                    ...
                    <!--</div>-->
                    <!--<div class="form-check d-inline-block me-3 mt-3"> &lt;!&ndash; d-inline-block을 사용하여 인라인 블록으로 설정 &ndash;&gt;-->
                    <!--    <input class="form-check-input" type="radio" name="affiliation" id="swime" value="스위미" v-model="formData.affiliation">-->
                    <!--    <label class="form-check-label" for="swime">스위미</label>-->
                    <!--</div>-->
                    ...
                    <!--    <label class="form-check-label me-2" for="other">기타</label> &lt;!&ndash; 오른쪽 마진 추가 &ndash;&gt;-->
                    <!--    <input-->
                    <!--        type="text"-->
                    <!--        class="form-control"-->
            ...
            <div style="background:#f6faff; border:1px solid #eee; border-radius: 2px; padding:10px; margin: 30px 0">
                <label class="form-label fw-bold">ZOO,어깨탈골,보노보노 연합MT 안내</label>
                <p style="font-size:12px;">
                    📣📣 9월 13-14 ZOO,어깨탈골,보노보노 연합MT 📣📣<br>
                    1. 장소: 송정 (미확정)<br>
                    2. 보노보노, ZOO 에서 숙소비 일부 찬조 <br>
                    3. 정확한 일정은 추후 공지<br>
