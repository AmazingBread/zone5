    ...
    <div>
        ...
        <div class="col-12 p-1">
            <div
                ...
                style="font-size: 20px; "
            >
                <a href="https://open.kakao.com/o/gaMZb5fi" target="_blank" style="text-decoration: none; color: inherit;">
                    ZONE4 창원 대회 채팅방 (실명)
                </a>
            </div>
        </div>
...
export default {
    data(){
        return {
            ...
            firstComeLimit: 50,
            deadline: new Date('2026-02-30T13:59:59'),
